...
ggplot(data_kickstarter, aes(x=reorder(country, table(country)[country]))) +
    ...
    scale_y_log10(breaks=c(10,100,1000,10000,30000,100000,300000),labels=label_comma() ) +
    labs(title = "Quantité de projets selon le pays", x="Code Pays",y="Nombre de projets",caption="Note: l'échelle est logarithmique")+
    coord_flip()+
    theme_minimal()
```
...
ggplot(data_kickstarter, aes(x=reorder(country, -table(country)[country]), fill=state)) +
    ...
    scale_fill_manual(breaks = c("suspended","canceled","failed","live","successful"),values=c("grey", "orange", "red", "blue", "green")) +
    scale_y_continuous(labels = scales::percent_format()) +
    labs(title = "Répartition des statuts des projets selon le pays", x="Code Pays",y="",colour="Statut")+
    theme_minimal()
```
