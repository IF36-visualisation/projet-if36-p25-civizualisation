...
```{r}
ggplot(data_kickstarter,aes(x=reorder(country,-table(country)[country]), fill=state)) + geom_bar() + scale_y_log10() + scale_fill_manual(values=c("orange", "red", "blue","green","black","grey"))
...
```{r}
ggplot(data_kickstarter,aes(x=reorder(country,-table(country)[country]), fill=state)) + geom_bar(position="fill") + scale_y_log10() + scale_fill_manual(values=c("orange", "red", "blue","green","black","grey")) 
```
